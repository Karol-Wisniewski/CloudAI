class AwsTranslateAuthor {
    ...
    // TODO paste author's info below
    ...
    String translate(String targetLang) {
        // TODO run the translation
        // TODO replace <i> with attribute enabling do-not-translate flag
        return translator.translate(AUTHOR.replace("<i>", "<i translate=\"no\">"), "pl", "en");
    }
}